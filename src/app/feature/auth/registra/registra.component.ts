...
import { usuariosCreate, usuariosCreateModels } from '../../users/shared/Models/Users.Models';
import { UsersService } from '../../users/shared/services/users/users.service';
...
export class RegistraComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.formu = this.fb.group({
      ...
      documento:[null,[Validators.required,Validators.min(1000000),Validators.max(999999999999),Validators.pattern("^[-+]?[0-9]+$") ]],
